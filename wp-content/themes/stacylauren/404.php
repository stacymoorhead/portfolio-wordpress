		...
		<main id="main" class="site-main">
			...
			<section class="error-404 not-found">
				<header class="page-header">
					<h1 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'stacylauren' ); ?></h1>
				</header><!-- .page-header -->
				...
				<div class="page-content">
					...
					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'stacylauren' ); ?></h2>
						<ul>
							<?php
					...
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$stacylauren_archive_content" );
